...
# about your device
export DEVICE="gram" # codename used in device tree
export DT_LINK="https://github.com/GunaisHere/Twrp_miatoll.git" # device tree link
export DT_BRANCH="12" # device tree branch
